  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <button class="btn-primary flex items-center gap-2 cursor-pointer" :disabled="store.exporting" @click="handleExport('excel')">
        ...
        <button class="btn-danger flex items-center gap-2 cursor-pointer" :disabled="store.exporting" @click="handleExport('pdf')">
    ...
    <div class="card p-4">
      <div class="flex flex-wrap gap-3 items-end">
        ...
        <div class="flex items-end gap-2">
          <button class="btn-primary cursor-pointer" @click="applyFilters">Filtrer</button>
          <button class="btn-secondary cursor-pointer" @click="resetFilters">Réinitialiser</button>
        </div>
      </div>
    </div>
