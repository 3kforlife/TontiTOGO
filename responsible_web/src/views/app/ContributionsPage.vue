  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <button class="btn-primary flex items-center gap-2" :disabled="store.exporting" @click="handleExport('excel')">
        ...
        <button class="btn-danger flex items-center gap-2" :disabled="store.exporting" @click="handleExport('pdf')">
